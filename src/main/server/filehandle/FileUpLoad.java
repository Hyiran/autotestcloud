...
//	        根据时间+随机创建目录 ，动态存储
	        ...
	        DataHandle hd=new DataHandle();
	        String string=hd.getRadomString(5);
	        	
	        String p="/upload/"+time+string;
	        //获取文件需要上传到的路径  
	        ...
	        String  res ="附加上传成功";
//	         将落地文件 存入数据库
	        GetExcleDataToMySql gen=new GetExcleDataToMySql();
//	        获取文件路径
...
//	        
//	        读取文件数据并导入数据库
	        res= gen.doPost(request, response, exclePath);
//	      jsp中2个文件调用方法
