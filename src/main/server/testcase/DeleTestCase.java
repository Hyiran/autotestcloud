 ...
 * 删除测试用例
 */
@WebServlet("/DeleTestCase")
public class DeleTestCase extends HttpServlet implements Servlet {
...
//   	 删除主表
   	 mysql.getSqlResault("delete from testcasemain where casename='"+casename+"' ", false);
	     
//	 删除子表
	 mysql.getSqlResault("delete from "+caseStepTable+" where casename='"+casename+"' ", false); 
     stream.write("用例删除成功".getBytes("UTF-8"));	
	 
//     stream.write(casename.getBytes("UTF-8"));	
		}
